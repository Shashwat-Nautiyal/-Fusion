...
abstract contract OrderMixin is IOrderMixin, EIP712, SeriesEpochManager, Pausable, OnlyWethReceiver { //PredicateHelper , PermitAndCall removed 
    ...
    function _fill(
        ...
        // // Check if orders predicate allows filling (REMOVED)
